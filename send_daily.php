...
function sendMail($to, $name, $subject, $body, $config, $logoPath = null) {
    ...
    try {
        ...
        $mail->setFrom($config['mailFrom'], 'Department Finance');
...
$loyalty = $donations = $zCount = $cashSales = $allOtherSales = $currentFloat = $lodge = 0.0;
...
try {
    // Z Count calculation: (CurrentFloat + AE + Lodge) - PreviousDayFloat
...
<body>
    <div class='header'>
        " . ($logoPath ? "<img src='cid:logo_cid' alt='Company Logo' class='logo' />" : "<h2>Dept. Finance</h2>") . "
...
$emailFooter = "
    ...
    <div class='footer'>
        <p><strong>POS Company Name</strong><br>
        Address<br>
